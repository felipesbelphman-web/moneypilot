...
export function DashboardLoadingState() {
  ...
  return <div role="status" aria-live="polite" aria-busy="true" className="flex h-[725px] flex-col gap-[12px] pt-[12px]">
    <div className="flex h-[54px] items-center justify-between rounded-[14px] border border-[var(--border-default)] bg-[var(--background-card)] px-[14px]"><div><strong className="block text-[14px] text-[var(--text-primary)]">{t[0]}</strong><span className="text-[9px] text-[var(--text-secondary)]">{t[1]}</span></div><span className="rounded-full border border-[var(--dashboard-brand-border)] bg-[var(--dashboard-brand-soft)] px-[28px] py-[5px] text-[8px] font-semibold text-[var(--dashboard-brand-primary)]">{t[2]}</span></div>
    ...
    <div className="relative h-[724px] w-full">
      <section className="absolute left-1/2 top-[85px] h-[520px] w-[654px] -translate-x-1/2 overflow-hidden rounded-[24px] border border-[#D4D4D4] bg-white text-center shadow-[0_16px_28px_rgba(0,0,0,0.08)]">
        ...
        <div className="absolute left-[145px] top-[259px] flex gap-[10px]">
          <Link
            href="/transactions"
            className="flex h-[44px] w-[176px] items-center justify-center gap-[12px] rounded-[22px] bg-[var(--dashboard-brand-primary)] px-[16px] text-[11px] font-semibold text-white transition-colors hover:bg-[var(--dashboard-brand-primary-hover)] active:bg-[var(--dashboard-brand-primary-active)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--dashboard-focus)]"
          >
            {t[2]}
        ...
        <div className="absolute left-[33px] top-[365px] grid grid-cols-3 gap-[8px]">
          {steps.map(([title, text], index) => (
            ...
            >
              <div className="absolute left-[11px] top-[11px] grid size-[24px] place-items-center rounded-full border border-[var(--dashboard-brand-border)] bg-[var(--dashboard-brand-50)] text-[9px] font-semibold text-[var(--dashboard-brand-primary)]">
                {index + 1}
              </div>
