  ...
  en: {
    ...
    landing: {
      hero: {
        ...
        description:
          "Organize spending, track budgets, receive AI insights, and move toward your financial goals.",
  ...
  pt: {
    ...
    landing: {
      hero: {
        ...
        description:
          "Organize gastos, acompanhe orçamentos, receba insights da IA e avance rumo aos seus objetivos financeiros.",
  ...
  es: {
    ...
    landing: {
      hero: {
        ...
        description:
          "Organiza gastos, controla presupuestos, recibe información de la IA y avanza hacia tus objetivos financieros.",
